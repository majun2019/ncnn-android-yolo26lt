...
Android端使用NCNN框架，性能会有显著差异:

预估性能 (骁龙8 Gen2):
┌──────────┬──────────────┬──────────────┬──────────────┐
│ 尺寸     │ YOLO26 Legacy│ YOLO26 Many  │ YOLO26 E2E   │
├──────────┼──────────────┼──────────────┼──────────────┤
│ 320x320  │ ~25ms (~40FPS)│ ~23ms (~43FPS)│ ~16ms (~62FPS)│
│ 480x480  │ ~45ms (~22FPS)│ ~42ms (~24FPS)│ ~29ms (~34FPS)│
│ 640x640  │ ~80ms (~12FPS)│ ~75ms (~13FPS)│ ~52ms (~19FPS)│
└──────────┴──────────────┴──────────────┴──────────────┘
